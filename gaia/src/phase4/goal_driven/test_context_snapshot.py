...
def test_build_ref_candidates_includes_role_ref_after_dom_ref():
...
def test_resolve_stale_ref_uses_role_ref_name_nth():
    fresh_snapshot = {
        "elements_by_ref": {
...
def test_build_context_snapshot_assigns_container_ref_ids_and_children():
    elements = [
        _element(
            "21",
            "gaia-button-21",
